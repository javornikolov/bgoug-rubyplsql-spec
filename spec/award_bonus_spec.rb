describe "Award bonus" do
  ...
  context "With salary 10" do
    let!(:employee) { create_employee(:salary => 10) }

    it "employee salary should be 10" do
      expect(get_employee(employee[:employee_id])[:salary]).to eq 10
    end
  end
end
